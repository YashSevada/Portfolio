...
export declare class EmailsApi extends FaxDomainApi {
     ...
     */
    addToNumbers(data: AddEmailToNumbersRequestData): Promise<Email>;
    /**
     * Remove email
     ...
     */
    delete(data: DeleteEmailRequestData): Promise<void>;
    /**
     * List emails
     ...
     */
    listNumbers(data: ListNumbersByEmailRequestData): ApiListPromise<ServicePhoneNumber>;
    /**
     ...
     */
    update(data: UpdateEmailRequestData): Promise<Email>;
}
